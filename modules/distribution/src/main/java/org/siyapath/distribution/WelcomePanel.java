...
package org.siyapath.distribution;
...
public class WelcomePanel extends IzPanel
{
     ...
     * IzPanelLayout and the GridBagLayout. New panels should be use the IzPanelLayout. If lm is
    ...
    public WelcomePanel(InstallerFrame parent, InstallData iData, LayoutManager2 layout)
    {
    ...
    /**
     * Indicates weather the panel has been validated or not.
     *
     * @return Always true.
     */
